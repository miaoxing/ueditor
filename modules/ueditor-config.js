define(function () {
  ...
  window.UEDITOR_HOME_URL = '/comps/ueditor/';
  ...
  // NOTE: 兼容老的配置
  var config = requirejs.s.contexts._.config.config['ueditor.config'];
  ...
  window.UEDITOR_CONFIG = {
    ...
    // 图片上传配置区
    imageUrl: config.imageUrl || URL + 'php/imageUp.php',             // 图片上传提交地址
    ...
    catcherUrl: config.catcherUrl || URL + 'php/getRemoteImage.php',   // 处理远程图片抓取的地址
    catcherPath: '',
    // ,catcherPath:URL + "php/"                  //图片修正地址，同imagePath
    // ,catchFieldName:"upfile"                   //提交到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
    // ,separater:'ue_separate_ue'               //提交至后台的远程图片地址字符串分隔符
    localDomain: config.localDomain,                            // 本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地,默认不抓取127.0.0.1和localhost
