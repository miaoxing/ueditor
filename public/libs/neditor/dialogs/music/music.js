    ...
    Music.prototype = {
        ...
        _renderTemplate:function (data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                s.push('<div class="m-h"><span class="mt-3">' + lang.chapter + '</span><span class="m-s">' + lang.singer
                ...
                for (var j = 0, tmpObj; tmpObj = tmpList[j++];) {
                    ...
                    s.push('<input type="radio" id="radio-' + i + '-' + j + '" name="musicId" class="ml-3" onclick="music.doselect(' + (me.pageSize * (i-1) + (j-1)) + ')"/>');
                    s.push('<span class="mt-3">' + me._getMaxText(tmpObj.title) + '</span>');
